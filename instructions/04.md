...
In this exercise, you will deploy a Stream Analytics module to the Edge device and generate an alert notification if process control values are exceeded. You are provided a pre-created Linux based Azure VM configured as IoT Edge device for the purpose of this lab.
...
In this exercise, you leveraged Azure IoT Edge service to process messeges on Edge devices.
