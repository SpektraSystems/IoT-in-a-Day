...
![Lab 11 Architecture](media/lab4_architecture.png)
...
1. Replace the default route defined with the following three routes:
    ...
    * Route 3
    ...
    > **Note**: Be sure to replace the `iotstreamjob-{your-id}` placeholder with the name of your Azure Stream Analytics job module. You can click **Previous** to view the list of modules and their names, then click **Next** to come back to this step.
