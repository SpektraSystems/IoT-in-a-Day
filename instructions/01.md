...
1. On the left-side menu, under **Settings**, click **Built-in endpoints**
    ...
    IoT Hub exposes [**endpoints**](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-endpoints) that enable external connections. Essentially, an endpoint is anything connected to or communicating with your IoT Hub. You should see that your hub already has two endpoints defined:
