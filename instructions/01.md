...
1. To get the lab environment details, you can select the **Lab Environment** tab, you can locate the **Lab Environment** tab on the upper right corner. Additionally, the credentials will also be emailed to your email address provided during registration.
 ...
 > You will see Suffix/DeploymentID value on the **Lab Environment** tab, use it wherever you see SUFFIX or DeploymentID in lab steps.
...
In this task, you will connect Fabrikam, Inc.’s Turbine Devices to Azure IoT Hub and send telemetry from the simulated turbine device to IoT Hub. Here are you the high-level steps you will be performing:

   * Register the Turbine Devices to IoT Hub
   * Enable the registered devices you want to be a part of the solution
   * Start sending data from the devices
...
1. Click **IoT devices** under the Explorers section and you can observe the registered IoT devices we have registered in the previous steps.
...
In this exercise, you connected Fabrikam, Inc.’s turbine devices to Azure IoT Hub. And send telemetry to IoT Hub and verified the telemetry stream.
