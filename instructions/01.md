...
1. To get the lab environment details, you can select the **Lab Environment** tab, you can locat the **Lab Environment** tab on upper right corner. Additionally, the credentials will also be emailed to your email address provided during registration.
...
1. On the left-side menu, under **Settings**, click **Built-in endpoints**
  ...
  > **Note**:  You can explore more on IoT Hub endpoints from here: https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-endpoints
...
#### Task 4: Verify telemetry stream from Azure IoT Hub using IoT Explorer
