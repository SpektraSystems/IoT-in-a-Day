...
In this task, you will connect Fabrikam, Inc.’s Turbine Devices to Azure IoT Hub. Once connected, you will configure the turnbine devices to send telemetry to IoT Hub. Here are you the high-level steps you will be performing:
