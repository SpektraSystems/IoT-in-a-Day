...
In this task, you will examine some of the features that IoT Hub provides. 
...
1. Open the Azure Cloud Shell by navigating to **https://shell.azure.com**. Log in using your Azure subscription credentials if prompted to do so, select a **PowerShell** session, and accept any prompts or click the Cloud Shell button on the azure portal ![](media/cloudshell.png)
