...
In this exercise, you will connect devices deployed across the globe to Azure IoT Hub and and start sending telemetry data from turnbine devices to Azure IoT Hub.

You will be performing following activities to achieve the goal.
...
1. Navigate back to the IoT simulator application and Click on **Send Telemetry**. Within a few moments, the grid on the simulator application will list each telemetry message transmitted and the simulated temperature value.
   ...
   You've now configured the turnbines to send temperature data to Azure IoT Hub. 
...
1. Enter the **Connection string** value of IoT Hub. You used this value to connect turnbines devices in last task.
...
1. Select **Telemetry** from the left-hand side and click on the **Start** option.
   ...
   This enables you to monitor the data being sent to the IoT hub. You are also verifying that the device are able to connect and communicate with your IoT hub.

1. After 2-3 minutes you will receive telemetry data and you should be seeing messages displayed similar to the following: Take a look at sample data to review the temperature values. 
