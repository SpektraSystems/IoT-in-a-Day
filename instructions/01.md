...
1. Open the Azure Cloud Shell by navigating to **https://shell.azure.com**, select **PowerShell**.

1. Click on **Show advanced settings** and select existing Resource Group as **iot-{deployment-id}** and enter **iotstore{deployment-id}** for storage account name and Enter **blob** for File Share.
