...
The **Azure IoT explorer** is a graphical tool for interacting with and testing your IoT Plug and Play Preview devices. You can use the tool to view the telemetry the devices are sending, work with device properties, and invoke commands.
