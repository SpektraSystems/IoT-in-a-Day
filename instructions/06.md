...
* Review the alerts in the Azure Security Center
...
1. Take a moment to review the contents on the Security Overview pane.
    ...
    > **Note**: Threats are not instantly detected the immediately after onboarding Azure Security Center for IoT, you will begin to see threat detections reports on this Overview pane before the end of this lab. 
...
In this task, you will review workspace configuration of Log Analytics.
...
1. From the **Settings Page** pane , select **Monitored Resources** under **Names**
