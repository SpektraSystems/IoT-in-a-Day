...
In this task, you will take a quick look at the workspace configuration of Log Analytics with Azure Security Center for IoT.
...
In this task, you will be adding a security agent that you will deploy to your simulated device. 
